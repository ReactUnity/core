...
export function Classes() {
  ...
  const submit: EditorElements['input']['onKeyDown'] = useCallback((ev, sender) => {
    if (ev.keyCode === Interop.UnityEngine.KeyCode.Return ||
  ...
  const toggled: EditorElements['toggle']['onChange'] = useCallback((ev, sender) => {
