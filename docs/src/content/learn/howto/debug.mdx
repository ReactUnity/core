...
[Here](https://github.com/ReactUnity/core/blob/main/kitchen-sink/react/.vscode/launch.json#L6) is a sample `launch.json` file. Note that VSCode may not resolve sourcemaps correctly without the `resolveSourceMapLocations` line.
