...
## UI isn't working after build {/*ui-isnt-working-after-build*/}
...
#### You forgot to build UI code {/*you-forgot-to-build-ui-code*/}
...
#### You have an error in your code {/*you-have-an-error-in-your-code*/}
...
#### Issues caused by Code stripping {/*issues-caused-by-code-stripping*/}
...
#### It doesn't work in Android when minify is enabled {/*it-doesnt-work-in-android-when-minify-is-enabled*/}
