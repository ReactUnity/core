...
### Does ReactUnity work in desktop or mobile? {/*does-reactunity-work-in-desktop-or-mobile*/}

Yes, ReactUnity works in all platforms Unity builds to.

### How is the performance? {/*how-is-the-performance*/}
...
### Can I use CSS-in-JS, Sass, Tailwind, Bootstrap etc? {/*can-i-use-css-in-js-sass-tailwind-bootstrap-etc*/}

Yes. Tailwind is the recommended way to style a ReactUnity app, and plain CSS or Sass Modules work just as well. ReactUnity also supports most other styling libraries -- `emotion`, `styled-components`, `react-bootstrap`, `jss` and `twin.macro` are all confirmed to work. If you encounter an issue with them, please let us know.

Tailwind has a page of its own: [Using Tailwind CSS](/learn/howto/tailwind).

### Can I use ____ npm package? {/*can-i-use-____-npm-package*/}
...
### I have a question but I don't see it here... {/*i-have-a-question-but-i-dont-see-it-here*/}
