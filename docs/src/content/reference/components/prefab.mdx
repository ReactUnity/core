...
### Lifecycle events and properties {/*lifecycle-events-and-properties*/}
...
#### Example of a custom prefab target component: {/*example-of-a-custom-prefab-target-component*/}
```csharp
...
##### Example of a prefab with a custom target component: {/*example-of-a-prefab-with-a-custom-target-component*/}
```js
