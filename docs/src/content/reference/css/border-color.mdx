...
`border-inline-color` and `border-block-color` take one or two values each, and
`border-inline-start-color`, `border-inline-end-color`, `border-block-start-color` and
`border-block-end-color` set one edge.
