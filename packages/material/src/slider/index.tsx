...
const SliderChild = forwardRef(
  function _SliderChild({ callback, defaultValue }: { callback: SliderChildCallback, defaultValue: number }, ref) {
...
const _Slider = forwardRef<SliderRef, SliderProps>(
  function _Slider({
    ...
    const elementRef = useRef<ReactUnity.UGUI.ContainerComponent>();
    ...
    const setValWithStep = useCallback((val: number, skipNotify?: boolean, skipControl?: boolean) => {
