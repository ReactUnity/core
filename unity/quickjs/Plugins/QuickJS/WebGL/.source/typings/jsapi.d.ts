...
declare global {
  ...
  export declare interface JSApiExternals {
    ...
    static JS_SetModuleLoaderFuncAsync(rt: JSRuntime, module_normalize: IntPtr, module_loader: IntPtr, module_check_attrs: IntPtr, opaque: IntPtr): void;
    static JS_SetModuleMetaFunc(rt: JSRuntime, func: IntPtr, opaque: IntPtr): void;
    static JS_FulfillModuleLoad(ctx: JSContext, handle: IntPtr, source: Pointer<Byte>, source_len: size_t): int;
    static JS_RejectModuleLoad(ctx: JSContext, handle: IntPtr, error: JSValue): int;
    static JS_EvalModuleAsync(returnValue: JSValue, ctx: JSContext, input: Pointer<Byte>, input_len: size_t, filename: Pointer<Byte>);
    static JS_GetModuleName(ctx: JSContext, m: JSModuleDef): JSAtom;
    ...
    static JS_GetProperty(returnValue: JSValue, ctx: JSContext, obj: JSValue, prop: JSAtom);
    ...
    static JS_IsError(val: JSValue): Boolish;
    ...
    static JS_IsArray(val: JSValue): Boolish;
    ...
    static JS_SetConstructor(ctx: JSContext, func_obj: JSValue, proto: JSValue): int;
    static JS_SetProperty(ctx: JSContext, this_obj: JSValue, prop: JSAtom, val: JSValue): int;
