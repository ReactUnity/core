 ...
 * Why a fork on top of that: five parser changes ReactUnity needs, each an ordinary commit on
 ...
 * at upstream once it carries all five.
 *
...
writeFileSync(
  ...
  [
    ...
    '',
    `This is a fork of [${UPSTREAM}](${UPSTREAM}), five commits ahead of it, each with its own`,
