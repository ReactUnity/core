...
Built from ReactUnity **v{{version}}**.
...
To pin the version instead of following the branch, clone the tag `kitchen-sink/v{{version}}`.
...
|---|---|---|
| `com.reactunity.core` | {{version}} | OpenUPM |
| `com.reactunity.quickjs` | {{version}} | OpenUPM |
| `@reactunity/renderer`, `material`, `scripts` | {{version}} | npm |
