...
function Sliders() {
  ...
  return (
    <section>
      ...
      <Slider allowScroll direction="horizontal" mode="normal" max={100} step={20}>
        {(val) => val * val}
      </Slider>
      <Slider allowScroll direction="horizontal" mode="diff" defaultValue={20} max={100} step={20}>
        {(val) => val * val}
      </Slider>
      <Slider allowScroll direction="horizontal-reverse" mode="normal" defaultValue={40} max={100} step={20}>
        asdf
      </Slider>
      <Slider onChange={(x) => console.log(x)} allowScroll direction="horizontal-reverse" mode="diff" max={100} step={20}>
        asdf
      </Slider>

      <Slider allowScroll direction="horizontal" mode="normal" value={sliderVal} onChange={setSliderVal} max={100} step={20}>
        {(val) => val * val}
      </Slider>
      <Slider allowScroll direction="horizontal" mode="normal" value={sliderVal} readOnly onChange={setSliderVal} max={100} step={20}>
        {(val) => val * val}
      </Slider>
    </section>
  );
        ...
        <view style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
          <view style={{ alignItems: 'center', gap: 10 }}>
            <Button
              ...
              data-tooltip-content="This is shown on top"
            >
              Top
            </Button>
            <Button
              ...
              data-tooltip-content="This is shown on bottom"
            >
              Bottom
            </Button>
            <Button
              ...
              data-tooltip-content="This is shown on left"
            >
              Left
            </Button>
            <Button
              ...
              data-tooltip-content="This is shown on right"
            >
              Right
            </Button>
            <Button
              ...
              data-tooltip-content="This is shown on center"
            >
              Center
            </Button>
            <Button
              ...
              ref={tt.register}
              data-tooltip-delay={600}
              data-tooltip-anchor="bottom right"
              data-tooltip-pivot="top left"
              data-tooltip-content="This is shown on right bottom corner"
            >
              Custom
            </Button>
          </view>
