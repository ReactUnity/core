...
namespace ReactUnity.Styling
{
    public static class StyleProperties
    {
        ...
        public static readonly StyleProperty<float> lineHeight = new StyleProperty<float>("lineHeight", DynamicFontSizeValue.Default, true, true, AllConverters.LengthConverter);
