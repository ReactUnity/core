            ...
            for (int ci = 0; ci < count; ci++)
            {
                ...
                switch (name)
                {
                    case "translate":
                        ...
                        xArg = AllConverters.YogaValueConverter.Convert(args[0]);
                        if (xArg is YogaValue xv) translate = new YogaValue2(SumYogaValues(translate.X, xv), translate.Y);

                        if (argCount > 1)
                        {
                            yArg = AllConverters.YogaValueConverter.Convert(args[1]);
                    ...
                    case "translate3d":
                        ...
                        xArg = AllConverters.YogaValueConverter.Convert(args[0]);
                        yArg = AllConverters.YogaValueConverter.Convert(args[1]);
                        zArg = AllConverters.YogaValueConverter.Convert(args[2]);
                    ...
                    case "translateY":
                        ...
                        yArg = AllConverters.YogaValueConverter.Convert(args[0]);
                    ...
                    case "translateZ":
                        ...
                        zArg = AllConverters.YogaValueConverter.Convert(args[0]);
                    ...
                    case "rotateZ":
                        ...
                        zArg = AllConverters.AngleConverter.Convert(args[0]);
                        if (zArg is float rz1) rotate *= Quaternion.Euler(0, 0, rz1);

                        break;
                    case "rotate3d":
                        if (argCount != 3) continue;
                        xArg = AllConverters.AngleConverter.Convert(args[0]);
                        yArg = AllConverters.AngleConverter.Convert(args[1]);
                        zArg = AllConverters.AngleConverter.Convert(args[2]);
                    ...
                    case "rotateY":
                        ...
                        yArg = AllConverters.AngleConverter.Convert(args[0]);
                        if (yArg is float ry1) rotate *= Quaternion.Euler(0, ry1, 0);
                        break;
                    case "scale":
                        if (argCount > 2) continue;
                        xArg = AllConverters.FloatConverter.Convert(args[0]);
                        if (xArg is float xs) scale = new Vector3(scale.x * xs, scale.y, scale.z);

                        if (argCount > 1)
                        {
                            yArg = AllConverters.FloatConverter.Convert(args[1]);
                    ...
                    case "scale3d":
                        ...
                        xArg = AllConverters.FloatConverter.Convert(args[0]);
                        yArg = AllConverters.FloatConverter.Convert(args[1]);
                        zArg = AllConverters.FloatConverter.Convert(args[2]);
