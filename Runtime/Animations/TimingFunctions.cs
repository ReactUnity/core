...
namespace ReactUnity.Animations
{
    ...
    {
        public static readonly TimingFunction Linear = CubicBezierFunction.Create(0, 0, 1, 1);
        public static readonly TimingFunction Ease = CubicBezierFunction.Create(0.25f, 0.1f, 0.25f, 1f);
        public static readonly TimingFunction EaseIn = CubicBezierFunction.Create(0.42f, 0f, 1f, 1f);
        public static readonly TimingFunction EaseOut = CubicBezierFunction.Create(0f, 0f, 0.58f, 1f);
        public static readonly TimingFunction EaseInOut = CubicBezierFunction.Create(0.42f, 0f, 0.58f, 1f);
    ...
    public static class CubicBezierFunction
    {
