...
");
            ...
            Assert.AreEqual(0, kfs.From.Rules["opacity"]);
            Assert.AreEqual(new Vector2(0.8f, 0.8f), kfs.From.Rules["scale"]);

            Assert.AreEqual(1, kfs.To.Rules["opacity"]);
            Assert.AreEqual(new Vector2(1, 1), kfs.To.Rules["scale"]);
        }
    }
}
