...
namespace ReactUnity.Tests.Editor
{
    ...
    {
        // Hashes cover the ramp texture contents. They were refreshed once to match b0fc4788,
        // which converted the ramp to linear space unconditionally and so darkened every
        // gradient by 2.2 in a gamma-space project; these are the original values, which
        // Gradient.cs reproduces again now that the conversion follows the colour space.
