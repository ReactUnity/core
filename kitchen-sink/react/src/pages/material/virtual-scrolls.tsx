...
const FixedGridExample = () => (
  <FixedSizeGrid columnCount={1000} columnWidth={100} height={450} rowCount={1000} rowHeight={35} width={450}>
    {Cell as any}
  </FixedSizeGrid>
);
...
const FixedSizeExample = () => (
  <FixedSizeList height={450} itemCount={1000} itemSize={30} width={300} smoothness={0}>
    {Row}
  </FixedSizeList>
);

const VariableSizeExample = () => (
  <VariableSizeList height={450} itemCount={1000} itemSize={getItemSize} width={300}>
    {Row}
  </VariableSizeList>
);
