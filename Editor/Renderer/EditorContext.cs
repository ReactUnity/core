    ...
    public class EditorContext : ReactContext
    {
        ...
        public static Dictionary<string, Func<string, string, EditorContext, IEditorComponent<VisualElement>>> ComponentCreators
            = new Dictionary<string, Func<string, string, EditorContext, IEditorComponent<VisualElement>>>()
            {
                ...
                { "image", (tag, text, context) => new EditorComponent<Image>(context, tag) },
                { "scroll", (tag, text, context) => new EditorComponent<ScrollView>(context, tag) },
                { "input", (tag, text, context) => new BaseFieldComponent<TextField, string>(context, tag) },
                { "helpbox", (tag, text, context) => new EditorComponent<HelpBox>(context, tag) },
                { "foldout", (tag, text, context) => new EditorComponent<Foldout>(context, tag) },
                { "popup", (tag, text, context) => new EditorComponent<PopupWindow>(context, tag) },
                ...
                { "repeat", (tag, text, context) => new EditorComponent<RepeatButton>(context, tag) },
                { "scroller", (tag, text, context) => new EditorComponent<Scroller>(context, tag) },
                { "list", (tag, text, context) => new EditorComponent<ListView>(context, tag) },
                { "imgui", (tag, text, context) => new IMGUIComponent(context) },
                { "template", (tag, text, context) => new EditorComponent<TemplateContainer>(context, tag) },
                ...
                { "inspector", (tag, text, context) => new EditorComponent<InspectorElement>(context, tag) },
                ...
                { "progress", (tag, text, context) => new EditorComponent<ProgressBar>(context, tag) },
                { "property", (tag, text, context) => new EditorComponent<PropertyField>(context, tag) },
                ...
                { "tb-menu", (tag, text, context) => new EditorComponent<ToolbarMenu>(context, tag) },
                { "tb-popupsearch", (tag, text, context) => new EditorComponent<ToolbarPopupSearchField>(context, tag) },
                { "tb-search", (tag, text, context) => new EditorComponent<ToolbarSearchField>(context, tag) },
