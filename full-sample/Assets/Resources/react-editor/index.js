...
(function (Unity) {
  ...
  (function (Rendering) {
    ...
    (function (HybridV2) {})(HybridV2 = Rendering.HybridV2 || (Rendering.HybridV2 = {}));
...
(function (UnityEngine) {
  ...
  (function (AI) {})(AI = UnityEngine.AI || (UnityEngine.AI = {}));

  var Analytics;

  (function (Analytics_1) {})(Analytics = UnityEngine.Analytics || (UnityEngine.Analytics = {}));

  var Animations;

  (function (Animations) {})(Animations = UnityEngine.Animations || (UnityEngine.Animations = {}));
  ...
  (function (Audio) {})(Audio = UnityEngine.Audio || (UnityEngine.Audio = {}));

  var Diagnostics;

  (function (Diagnostics) {})(Diagnostics = UnityEngine.Diagnostics || (UnityEngine.Diagnostics = {}));

  var Events;

  (function (Events) {})(Events = UnityEngine.Events || (UnityEngine.Events = {}));

  var EventSystems;

  (function (EventSystems) {})(EventSystems = UnityEngine.EventSystems || (UnityEngine.EventSystems = {}));
  ...
  (function (Experimental) {
    ...
    (function (AI) {})(AI = Experimental.AI || (Experimental.AI = {}));

    var Animations;

    (function (Animations) {})(Animations = Experimental.Animations || (Experimental.Animations = {}));
    ...
    (function (GlobalIllumination) {})(GlobalIllumination = Experimental.GlobalIllumination || (Experimental.GlobalIllumination = {}));
  ...
  (function (iOS) {})(iOS = UnityEngine.iOS || (UnityEngine.iOS = {}));
  ...
  (function (Networking) {
    ...
    (function (PlayerConnection_1) {})(PlayerConnection = Networking.PlayerConnection || (Networking.PlayerConnection = {}));
  })(Networking = UnityEngine.Networking || (UnityEngine.Networking = {}));

  var Playables;

  (function (Playables) {})(Playables = UnityEngine.Playables || (UnityEngine.Playables = {}));
  ...
  (function (Profiling) {
    ...
    (function (Memory) {
      ...
      (function (Experimental) {})(Experimental = Memory.Experimental || (Memory.Experimental = {}));
    })(Memory = Profiling.Memory || (Profiling.Memory = {}));
  })(Profiling = UnityEngine.Profiling || (UnityEngine.Profiling = {}));

  var Rendering;

  (function (Rendering) {})(Rendering = UnityEngine.Rendering || (UnityEngine.Rendering = {}));

  var SceneManagement;

  (function (SceneManagement) {})(SceneManagement = UnityEngine.SceneManagement || (UnityEngine.SceneManagement = {}));

  var Scripting;

  (function (Scripting) {})(Scripting = UnityEngine.Scripting || (UnityEngine.Scripting = {}));
  ...
  (function (tvOS) {})(tvOS = UnityEngine.tvOS || (UnityEngine.tvOS = {}));
  ...
  (function (UI) {})(UI = UnityEngine.UI || (UnityEngine.UI = {}));
  ...
  (function (Video) {})(Video = UnityEngine.Video || (UnityEngine.Video = {}));
  ...
  (function (Windows) {
    ...
    (function (Speech) {})(Speech = Windows.Speech || (Windows.Speech = {}));

    var WebCam;

    (function (WebCam_1) {})(WebCam = Windows.WebCam || (Windows.WebCam = {}));
  })(Windows = UnityEngine.Windows || (UnityEngine.Windows = {}));

  var WSA;

  (function (WSA) {})(WSA = UnityEngine.WSA || (UnityEngine.WSA = {}));
...
(function (UnityEditor) {
  ...
  (function (Animations) {})(Animations = UnityEditor.Animations || (UnityEditor.Animations = {}));
  ...
  (function (Build) {
    ...
    (function (Content) {})(Content = Build.Content || (Build.Content = {}));

    var Player;

    (function (Player) {})(Player = Build.Player || (Build.Player = {}));

    var Reporting;

    (function (Reporting) {})(Reporting = Build.Reporting || (Build.Reporting = {}));
  })(Build = UnityEditor.Build || (UnityEditor.Build = {}));

  var Compilation;

  (function (Compilation) {})(Compilation = UnityEditor.Compilation || (UnityEditor.Compilation = {}));
  ...
  (function (Experimental) {
    ...
    (function (Build) {
      ...
      (function (AssetBundle) {})(AssetBundle = Build.AssetBundle || (Build.AssetBundle = {}));
    ...
    (function (SceneManagement) {})(SceneManagement = Experimental.SceneManagement || (Experimental.SceneManagement = {}));

    var TerrainAPI;

    (function (TerrainAPI) {})(TerrainAPI = Experimental.TerrainAPI || (Experimental.TerrainAPI = {}));
  })(Experimental = UnityEditor.Experimental || (UnityEditor.Experimental = {}));

  var Hardware;

  (function (Hardware) {})(Hardware = UnityEditor.Hardware || (UnityEditor.Hardware = {}));
  ...
  (function (IMGUI) {
    ...
    (function (Controls) {})(Controls = IMGUI.Controls || (IMGUI.Controls = {}));
  ...
  (function (MemoryProfiler) {})(MemoryProfiler = UnityEditor.MemoryProfiler || (UnityEditor.MemoryProfiler = {}));

  var MPE;

  (function (MPE) {})(MPE = UnityEditor.MPE || (UnityEditor.MPE = {}));
  ...
  (function (Rendering) {})(Rendering = UnityEditor.Rendering || (UnityEditor.Rendering = {}));

  var SceneManagement;

  (function (SceneManagement) {})(SceneManagement = UnityEditor.SceneManagement || (UnityEditor.SceneManagement = {}));
  ...
  (function (SearchService) {})(SearchService = UnityEditor.SearchService || (UnityEditor.SearchService = {}));

  var ShortcutManagement;

  (function (ShortcutManagement) {})(ShortcutManagement = UnityEditor.ShortcutManagement || (UnityEditor.ShortcutManagement = {}));

  var Sprites;

  (function (Sprites) {})(Sprites = UnityEditor.Sprites || (UnityEditor.Sprites = {}));
  ...
  (function (VersionControl) {})(VersionControl = UnityEditor.VersionControl || (UnityEditor.VersionControl = {}));
...
(function (ReactUnity_1) {
  ...
  (function (StyleEngine) {})(StyleEngine = ReactUnity_1.StyleEngine || (ReactUnity_1.StyleEngine = {}));
  ...
  (function (Styling) {
    ...
    (function (Types) {})(Types = Styling.Types || (Styling.Types = {}));
  })(Styling = ReactUnity_1.Styling || (ReactUnity_1.Styling = {}));

  var Types;

  (function (Types) {})(Types = ReactUnity_1.Types || (ReactUnity_1.Types = {}));
  ...
  (function (WebSupport) {})(WebSupport = ReactUnity_1.WebSupport || (ReactUnity_1.WebSupport = {}));
...
(function (System) {
  ...
  (function (CodeDom) {
    ...
    (function (Compiler) {})(Compiler = CodeDom.Compiler || (CodeDom.Compiler = {}));
  ...
  (function (Collections) {
    ...
    (function (Concurrent) {})(Concurrent = Collections.Concurrent || (Collections.Concurrent = {}));
    ...
    (function (Specialized) {})(Specialized = Collections.Specialized || (Collections.Specialized = {}));
  ...
  (function (Diagnostics) {
    ...
    (function (Eventing) {
      ...
      (function (Reader) {})(Reader = Eventing.Reader || (Eventing.Reader = {}));
    })(Eventing = Diagnostics.Eventing || (Diagnostics.Eventing = {}));

    var PerformanceData;

    (function (PerformanceData) {})(PerformanceData = Diagnostics.PerformanceData || (Diagnostics.PerformanceData = {}));

    var SymbolStore;

    (function (SymbolStore) {})(SymbolStore = Diagnostics.SymbolStore || (Diagnostics.SymbolStore = {}));

    var Tracing;

    (function (Tracing) {})(Tracing = Diagnostics.Tracing || (Diagnostics.Tracing = {}));
  ...
  (function (Globalization) {})(Globalization = System.Globalization || (System.Globalization = {}));
  ...
  (function (IO) {
    ...
    (function (Compression) {})(Compression = IO.Compression || (IO.Compression = {}));

    var IsolatedStorage;

    (function (IsolatedStorage_1) {})(IsolatedStorage = IO.IsolatedStorage || (IO.IsolatedStorage = {}));

    var MemoryMappedFiles;

    (function (MemoryMappedFiles) {})(MemoryMappedFiles = IO.MemoryMappedFiles || (IO.MemoryMappedFiles = {}));

    var Pipes;

    (function (Pipes) {})(Pipes = IO.Pipes || (IO.Pipes = {}));

    var Ports;

    (function (Ports) {})(Ports = IO.Ports || (IO.Ports = {}));
  ...
  (function (Linq) {
    ...
    (function (Expressions) {})(Expressions = Linq.Expressions || (Linq.Expressions = {}));
  ...
  (function (Management) {
    ...
    (function (Instrumentation) {})(Instrumentation = Management.Instrumentation || (Management.Instrumentation = {}));
  ...
  (function (Reflection) {
    ...
    (function (Emit) {})(Emit = Reflection.Emit || (Reflection.Emit = {}));
  ...
  (function (Resources) {})(Resources = System.Resources || (System.Resources = {}));
  ...
  (function (Runtime) {
    ...
    (function (CompilerServices) {})(CompilerServices = Runtime.CompilerServices || (Runtime.CompilerServices = {}));

    var ConstrainedExecution;

    (function (ConstrainedExecution) {})(ConstrainedExecution = Runtime.ConstrainedExecution || (Runtime.ConstrainedExecution = {}));
    ...
    (function (InteropServices) {
      ...
      (function (ComTypes) {})(ComTypes = InteropServices.ComTypes || (InteropServices.ComTypes = {}));
    ...
    (function (Remoting) {
      ...
      (function (Activation) {})(Activation = Remoting.Activation || (Remoting.Activation = {}));

      var Channels;

      (function (Channels) {})(Channels = Remoting.Channels || (Remoting.Channels = {}));
      ...
      (function (Lifetime) {})(Lifetime = Remoting.Lifetime || (Remoting.Lifetime = {}));
    ...
    (function (Versioning) {})(Versioning = Runtime.Versioning || (Runtime.Versioning = {}));
  ...
  (function (Security) {
    ...
    (function (AccessControl) {})(AccessControl = Security.AccessControl || (Security.AccessControl = {}));
    ...
    (function (Cryptography) {
      ...
      (function (X509Certificates) {})(X509Certificates = Cryptography.X509Certificates || (Cryptography.X509Certificates = {}));
    })(Cryptography = Security.Cryptography || (Security.Cryptography = {}));

    var Permissions;

    (function (Permissions) {})(Permissions = Security.Permissions || (Security.Permissions = {}));

    var Policy;

    (function (Policy) {})(Policy = Security.Policy || (Security.Policy = {}));

    var Principal;

    (function (Principal) {})(Principal = Security.Principal || (Security.Principal = {}));
  ...
  (function (Text) {
    ...
    (function (RegularExpressions) {})(RegularExpressions = Text.RegularExpressions || (Text.RegularExpressions = {}));
  ...
  (function (Threading) {
    ...
    (function (Tasks) {})(Tasks = Threading.Tasks || (Threading.Tasks = {}));
  ...
  (function (Web) {})(Web = System.Web || (System.Web = {}));
})(System || (System = {}));
...
var dd=UnityEditor.DragAndDrop;var startPos=UnityEngine.Vector3.zero;var curPos=UnityEngine.Vector3.zero;function App(){var ongui=(0,react.useMemo)(function(){return function(){var y=im.current.Element.worldBound.yMin;var st=new UnityEngine.Vector3(startPos.x,startPos.y-y,0);var en=new UnityEngine.Vector3(curPos.x,curPos.y-y,0);var tanDist=new UnityEngine.Vector3(st.x-en.x,st.y-en.y,0).magnitude/2;var stan=new UnityEngine.Vector3(st.x+tanDist,st.y,0);var etan=new UnityEngine.Vector3(en.x+tanDist,en.y,0);UnityEditor.Handles.DrawBezier(st,en,stan,etan,UnityEngine.Color.yellow,null,4);};},[]);var boxes=[0,1,2,3];var im=(0,react.useRef)();return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{style:{flexGrow:1},onDragUpdated:function onDragUpdated(ev){var _im$current;curPos=new UnityEngine.Vector3(ev.mousePosition.x,ev.mousePosition.y,0);(_im$current=im.current)===null||_im$current===void 0?void 0:_im$current.MarkDirtyRepaint();},children:[/*#__PURE__*/(0,jsx_runtime.jsx)("imgui",{onGUI:ongui,className:src_index_module.canvas,ref:im}),boxes.map(function(b){return/*#__PURE__*/(0,jsx_runtime.jsx)(Box,{id:b},b);})]});};function Box(_ref){var id=_ref.id;return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:src_index_module.box,style:{left:id*102,top:id*42},children:["This is a box",/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"".concat(src_index_module.handle," handle"),onPointerDown:function onPointerDown(ev,sender){dd.PrepareStartDrag();dd.SetGenericData('id',id);dd.StartDrag('Title');curPos=startPos=new UnityEngine.Vector3(ev.position.x,ev.position.y,0);},onMouseUp:function onMouseUp(ev,sender){sender.ReleaseMouse();},onMouseMove:function onMouseMove(ev,sender){if(sender.HasMouseCapture()){curPos=new UnityEngine.Vector3(ev.mousePosition.x,ev.mousePosition.y,0);}},onDragUpdated:function onDragUpdated(ev){curPos=new UnityEngine.Vector3(ev.mousePosition.x,ev.mousePosition.y,0);if(dd.GetGenericData('id')===id)dd.visualMode=UnityEditor.DragAndDropVisualMode.Rejected;else dd.visualMode=UnityEditor.DragAndDropVisualMode.Link;},onDragPerform:function onDragPerform(){console.log("Incoming ID ".concat(dd.GetGenericData('id'),". This ID ").concat(id,"."));dd.AcceptDrag();}})]});}Renderer.render(/*#__PURE__*/(0,jsx_runtime.jsx)(App,{}));
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".src_canvas__2-tTS{position:absolute;left:0;right:0;top:0;bottom:0}.src_box__3DwLz{width:100px;height:40px;position:absolute;left:0;top:0;background-color:0.9;border-width:1px;border-radius:6px}.src_handle__2zXtP{position:absolute;right:-5px;top:10px;width:10px;height:10px;border-radius:5px;background-color:yellow;margin:0;padding:0}\n", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"canvas": "src_canvas__2-tTS",
	"box": "src_box__3DwLz",
	"handle": "src_handle__2zXtP"
};
