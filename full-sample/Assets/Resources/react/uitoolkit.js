...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `:root>*{background-color:#fafafa}@font-face{font-family:Underdog;src:url(res:Underdog)}.home_app__IyZ\\+K{padding:20px;max-width:960px;width:100%;align-self:center;align-items:stretch}.home_app__IyZ\\+K h1{font-size:36px;font-style:smallcaps,bold;color:#582a9c;margin-bottom:12px;font-family:Underdog}.home_app__IyZ\\+K h2{font-size:30px;font-style:smallcaps;color:#fb2f8e;margin-bottom:8px}.home_app__IyZ\\+K section{margin-top:10px;margin-bottom:10px}.home_app__IyZ\\+K row{flex-direction:row;align-items:center}.home_app__IyZ\\+K column{flex-direction:column;align-items:center;flex-grow:1;flex-shrink:0}.home_app__IyZ\\+K image{flex-grow:1;flex-shrink:1;flex-basis:0;object-fit:scale-down;object-position:50%;transition:object-position 2s;align-self:stretch}.home_app__IyZ\\+K input{border-width:1px;border-color:#000}.home_app__IyZ\\+K button:hover{audio:url(res:click)}`, ""]);
// Exports
...
/******/ 	let __webpack_exports__ = __webpack_require__("./src/entry/uitoolkit.tsx");
/******/ 	
/******/ })()
;