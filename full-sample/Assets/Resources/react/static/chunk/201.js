...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root>*{background-color:#fafafa}.uitoolkit_app__3XzKz{padding:20px;max-width:960px;width:100%;align-self:center;align-items:stretch}.uitoolkit_app__3XzKz h1{font-size:36px;font-style:smallcaps,bold;color:#582a9c;margin-bottom:12px}.uitoolkit_app__3XzKz h2{font-size:30px;font-style:smallcaps;color:#fb2f8e;margin-bottom:8px}.uitoolkit_app__3XzKz section{margin-top:10px;margin-bottom:10px}.uitoolkit_app__3XzKz row{flex-direction:row;align-items:center}.uitoolkit_app__3XzKz column{flex-direction:column;align-items:center;flex-grow:1;flex-shrink:0}.uitoolkit_app__3XzKz image{flex-grow:1;flex-shrink:1;flex-basis:0;object-fit:scale-down;object-position:50%;transition:object-position 2s;align-self:stretch}.uitoolkit_app__3XzKz input{border-width:1px;border-color:#000}.uitoolkit_app__3XzKz button:hover{audio:url(res:click)}", "",{"version":3,"sources":["webpack://./src/uitoolkit/index.module.scss"],"names":[],"mappings":"AAAA,QACE,wBAAA,CAGF,sBACE,YAAA,CACA,eAAA,CACA,UAAA,CACA,iBAAA,CACA,mBAAA,CAEA,yBACE,cAAA,CACA,yBAAA,CACA,aAAA,CACA,kBAAA,CAGF,yBACE,cAAA,CACA,oBAAA,CACA,aAAA,CACA,iBAAA,CAGF,8BACE,eAAA,CACA,kBAAA,CAGF,0BACE,kBAAA,CACA,kBAAA,CAGF,6BACE,qBAAA,CACA,kBAAA,CACA,WAAA,CACA,aAAA,CAGF,4BACE,WAAA,CACA,aAAA,CACA,YAAA,CACA,qBAAA,CACA,mBAAA,CACA,6BAAA,CACA,kBAAA,CAGF,4BACE,gBAAA,CACA,iBAAA,CAIA,mCACE,oBAAA","sourcesContent":[":root > * {\n  background-color: #fafafa;\n}\n\n.app {\n  padding: 20px;\n  max-width: 960px;\n  width: 100%;\n  align-self: center;\n  align-items: stretch;\n\n  h1 {\n    font-size: 36px;\n    font-style: smallcaps, bold;\n    color: #582a9c;\n    margin-bottom: 12px;\n  }\n\n  h2 {\n    font-size: 30px;\n    font-style: smallcaps;\n    color: #fb2f8e;\n    margin-bottom: 8px;\n  }\n\n  section {\n    margin-top: 10px;\n    margin-bottom: 10px;\n  }\n\n  row {\n    flex-direction: row;\n    align-items: center;\n  }\n\n  column {\n    flex-direction: column;\n    align-items: center;\n    flex-grow: 1;\n    flex-shrink: 0;\n  }\n\n  image {\n    flex-grow: 1;\n    flex-shrink: 1;\n    flex-basis: 0;\n    object-fit: scale-down;\n    object-position: 50%;\n    transition: object-position 2s;\n    align-self: stretch;\n  }\n\n  input {\n    border-width: 1px;\n    border-color: black;\n  }\n\n  button {\n    &:hover {\n      audio: url(res:click);\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"app": "uitoolkit_app__3XzKz"
};
...
// EXTERNAL MODULE: ../../renderer/dist/src/renderer/renderer.js + 1 modules
var renderer = __webpack_require__(296);
