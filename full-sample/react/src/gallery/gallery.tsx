...
import { Renderer, FlexDirection, Wrap, YogaJustify, FontStyles, Position } from '@reactunity/renderer';
...
const renderGallery = (samples: Sample[]) => Renderer.render(<App samples={samples} />);
