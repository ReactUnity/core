...
Built from [https://github.com/ReactUnity/ExCSS](https://github.com/ReactUnity/ExCSS) at `48654e0ca1b9cfc4f643e1eeab84d2ccd5fd7c37` (branch `reactunity`), the commit the
`vendor/excss` submodule records, targeting `netstandard2.0`.

This is a fork of [https://github.com/TylerBrinks/ExCSS](https://github.com/TylerBrinks/ExCSS), seven commits ahead of it, each with its own
